...
A theme to showcase your app's features, workflow and promotional video.

[👀 Preview Theme](https://themesfor.app/preview/acanthus)
...
cd themesforapp
git sparse-checkout add acanthus
```
